...
Sources/
  GalleyCoreKit/              # framework — Galley-specific rendering, templates,
    ...
    Routing/                    # OpenBehavior+DisplayName.
